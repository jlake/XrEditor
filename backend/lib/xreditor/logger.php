 ...
 *
 * Usage:
 * $log = new xreditor_Logger('/var/log/', xreditor_Logger::INFO );
 ...
 * @version 0.1
 * @modified July 05, 2011 by Jlake Ou
 */

/**
 * Class documentation
 */
class xreditor_Logger
{
    /**
    ...
    /**
     * Array of xreditor_Logger instances, part of Singleton pattern
     * @var array
     */
     ...
     * @return xreditor_Logger
     */
    public static function instance($logDirectory = false, $severity = false, $logFile = '')
    {
        if ($severity === false) {
        ...
        self::$instances[$logDirectory] = new self($logDirectory, $severity, $logFile);
     ...
     * @return void
     */
    public function __construct($logDirectory, $severity, $logFile = '')
    {
        ...
        $this->_logFilePath = $logDirectory . DIRECTORY_SEPARATOR . $logFile;
    ...
    /**
     * Sets the date format used by all instances of xreditor_Logger
     * 
